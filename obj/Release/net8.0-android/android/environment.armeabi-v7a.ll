...
@dso_cache = dso_local local_unnamed_addr global [660 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 52239042, ; hash 0x31d1ac2, from name: HtmlAgilityPack
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 496473637, ; hash 0x1d979625, from name: aot-HtmlAgilityPack.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-HtmlAgilityPack.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	...
	%struct.DSOCacheEntry {
		i64 710531433, ; hash 0x2a59d969, from name: aot-PriceTrackerApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 715642471, ; hash 0x2aa7d667, from name: aot-PriceTrackerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PriceTrackerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		i64 950784206, ; hash 0x38abd0ce, from name: libaot-HtmlAgilityPack.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-HtmlAgilityPack.dll.so
		ptr null; void* handle (0x0)
	}, ; 138
	...
	%struct.DSOCacheEntry {
		i64 1884458220, ; hash 0x70528cec, from name: libaot-PriceTrackerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PriceTrackerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 280
	...
	%struct.DSOCacheEntry {
		i64 2047832599, ; hash 0x7a0f7217, from name: HtmlAgilityPack.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-HtmlAgilityPack.dll.so
		ptr null; void* handle (0x0)
	}, ; 309
	...
	%struct.DSOCacheEntry {
		i64 2293526507, ; hash 0x88b46feb, from name: libaot-HtmlAgilityPack
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-HtmlAgilityPack.dll.so
		ptr null; void* handle (0x0)
	}, ; 357
	...
	%struct.DSOCacheEntry {
		i64 3581607451, ; hash 0xd57afe1b, from name: PriceTrackerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PriceTrackerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 560
	...
	%struct.DSOCacheEntry {
		i64 3864695317, ; hash 0xe65a9215, from name: PriceTrackerApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PriceTrackerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 596
	...
	%struct.DSOCacheEntry {
		i64 4156957142, ; hash 0xf7c621d6, from name: libaot-PriceTrackerApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PriceTrackerApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 640
	...
	%struct.DSOCacheEntry {
		i64 4176518696, ; hash 0xf8f09e28, from name: aot-HtmlAgilityPack
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-HtmlAgilityPack.dll.so
		ptr null; void* handle (0x0)
	}, ; 645
